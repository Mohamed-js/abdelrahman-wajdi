...
export default function WorkDetails() {
  ...
  useEffect(() => {
    if (refProblem.current && refSolution.current) {
      ...
      refProblem.current.style.transform = `translateY(${-problemOffset * 0.1}px)`;
      refSolution.current.style.transform = `translateY(${solutionOffset * 0.1}px)`;
    }
  }, [scrollY]);
      ...
      {workDetails && (
        <div className="max-w-5xl mx-auto p-8  text-white my-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-32">
            <div className="bg-[#0e1114] rounded-lg shadow-xl p-6" ref={refProblem}>
              <h2 className="text-xl font-semibold mb-2 text-[#e6953e]">Problem</h2>
              <p className="text-lg text-gray-300">{workDetails.problem}</p>
            </div>
            <div className="bg-[#0e1114] rounded-lg shadow-xl p-6" ref={refSolution}>
              <h2 className="text-xl font-semibold mb-2 text-[#e6953e]">Solution</h2>
