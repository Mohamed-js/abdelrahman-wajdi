...
export default function Contact() {
  ...
  return (
    <div className="  bg-gradient-to-r bg-[#051118]  text-white p-4 md:p-12 text-center relative" id="contact-us">
      <div
      ...
      <div className="flex flex-col gap-5	md:flex-row md:gap-0 justify-around items-center">
        <div
          className="w-full  md:w-1/2 md:mr-10 rounded-xl pt-11 pb-8 px-8	bg-[#103743]"
          data-aos="fade-up"
        ...
        <div className="w-full  md:w-1/2 text-start text-[#63a1b4]">
          ...
          <div className="mb-3 flex items-start">
            ...
            <div className="max-w-xs">
              <span className="text-[#b7e4ea]">
                Office Number 4, 2253 Mohammed bin Abdullah bin Abdul Latif,
                7913, First Floor, Riyadh 12463, Kingdom of Saudi Arabia
              </span>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="text-[#b7e4ea]">
              <span className="block ">9.66501E+11</span>
